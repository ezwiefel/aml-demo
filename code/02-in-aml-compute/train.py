...
# Create a dummy explanation client for offine training
class DummyExplanationClient(object):
    """In offline mode, the ExplanationClient generates an error. This avoids the error"""
    def upload_model_explanation(*args, **kwargs):
        print("ExplanationClient.upload_model_explanation called.")
...
if __name__ == "__main__":
    ...
    try:
        ...
        client = DummyExplanationClient()
        
    X_train, X_test, y_train, y_test, column_names = load_train_test_dataset(args.data_path, args.file_name)
